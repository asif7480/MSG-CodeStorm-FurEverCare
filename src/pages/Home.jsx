...
<Layout>
  ...
  <div className="container my-5">
    <h2 className="section-title">Pet Care Sections</h2>
    {/* Pet Profile */}
        ...
        <div className="row">
            ...
            <div className="card">
              <div className="card-body">
                <div className="ratio ratio-16x9">
                  <video src="Assets/videos/teeth brush.mp4" autoPlay muted width="100%" />
                </div>
          ...
          <div className="col-md-4">
            <div className="card">
              <div className="card-body">
                <div className="ratio ratio-16x9">
                  <iframe src="https://www.youtube.com/embed/6c-Dlfe_B_c" allowFullScreen />
                </div>

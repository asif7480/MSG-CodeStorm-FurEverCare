...
function Owner() {
  return (
    ...
    <div className="container">
      ...
      <Hero
        title="Your Pet's Health & Happiness is Our Priority"
        description="We provide everything you need to keep your furry friends healthy and happy"
            ...
            <div className="card">
              <div className="card-body">
                <div className="text-center mb-4">
                  <img
                    src="https://images.unsplash.com/photo-1554692918-08fa0fdc9db3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=80"
                ...
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <p>
                      <strong>Last Vaccination:</strong> 03/15/2023
                    </p>
                    <p>
                      <strong>Next Vaccination:</strong> 09/15/2023
                    </p>
                    <p>
                      <strong>Vet:</strong> Dr. Sarah Johnson
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-body">
                ...
                >
                  <li className="nav-item" role="presentation">
                    <button
                      ...
                      id="pills-puppies-tab"
                      data-bs-toggle="pill"
                      data-bs-target="#pills-puppies"
                    >
                      Puppies
                    </button>
                  </li>
                ...
                <div className="tab-content" id="pills-tabContent">
                  <div className="tab-pane fade show active" id="pills-puppies">
                    ...
                    <p>
                      Puppies need specially formulated food for proper growth
                      and development.
                    </p>
                    <ul>
                  ...
                  <div className="tab-pane fade" id="pills-adults">
                    ...
                    <p>
                      Adult dogs typically need 2 meals per day. Adjust portions
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="ratio ratio-16x9">
                      <iframe
                        src="https://www.youtube.com/embed/OIjGpSdxhnE"
                        allowFullScreen
                      />
                    </div>
                    <h5 className="mt-3">Brushing Techniques</h5>
                    <p>
                      Learn how to properly brush your pet's coat to prevent
                      matting and reduce shedding.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="card-body">
                    <div className="ratio ratio-16x9">
                      <iframe
                        width="560"
                        height="315"
                        src="https://www.youtube.com/embed/s7hlcoA4Xpg?si=l1r2_UEm9_iF9_ew"
                    ...
                    <p>
                      Step-by-step guide to bathing your pet without causing
              ...
              <div className="col-md-4">
                <div className="card">
                  <div className="card-body">
                    <div className="ratio ratio-16x9">
                      <iframe
                        src="https://www.youtube.com/embed/HXGHNLbA0hQ"
                        allowFullScreen
                      />
                    </div>
                    <h5 className="mt-3">Nail Trimming</h5>
                    <p>
                      Safe techniques for trimming your pet's nails without
                  ...
                  <div className="card-body">
                    ...
                    <div className="ratio ratio-16x9 mb-3">
                      <iframe
                        width="560"
                        height="315"
                        src="https://www.youtube.com/embed/14xbJsKBJOE?si=9v6tQqybuJ7iayQ8"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin"
                        allowfullscreen
                    ...
                    <p>
                      Regular dental care is essential for your pet's overall
                      health. Brush their teeth regularly and provide dental
                      chews.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="ratio ratio-16x9 mb-3">
                      <iframe
                        width="560"
                        height="315"
                        src="https://www.youtube.com/embed/_1OyMNu4NcE?si=ATSPzfTOVDRNeKYl"
                        title="YouTube video player"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin"
                    ...
                    <p>
                      Maintain a healthy weight for your pet through proper diet
                      and regular exercise to prevent obesity-related health
                      issues.
                    </p>
                  </div>
                </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="col-md-12">
                    ...
                    <p>
                      Effective strategies for potty training your puppy or
                      adult dog with consistency and patience.
                    </p>
                  </div>
                </div>
              </div>
